...
import 'package:melody/app.dart';
import 'package:melody/services/audio/audio_player_service.dart';
import 'package:melody/services/audio/melody_audio_handler.dart';
...
Future<void> main() async {
  ...
  await AudioService.init<
    ...
    config: AudioServiceConfig(
      ...
      'com.example.melody.channel.audio',

      androidNotificationChannelName:
      'Melody Playback',

      androidNotificationChannelDescription:
      'Music playback controls for Melody',
